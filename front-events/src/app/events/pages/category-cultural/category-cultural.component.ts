...
@Component({
  ...
  templateUrl: './category-cultural.component.html',
  styleUrl: './category-cultural.component.css'
})
export class CategoryCulturalComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.eventService.buscar({ areaInteres: 'Culturales' }).subscribe();;
  }
