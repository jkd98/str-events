...
@Component({
  imports: [DatePipe],
  templateUrl: './category-concerts.component.html',
  styleUrl: './category-concerts.component.css'
})
export class CategoryConcertsComponent implements OnInit{
  ...
  ngOnInit(): void {
    ...
    this.eventService.buscar({areaInteres:'Conciertos'}).subscribe();
  }
